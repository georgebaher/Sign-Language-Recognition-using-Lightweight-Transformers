...
df = pd.read_parquet(os.getenv('WLASL100_HAND_POSE_ANGLES_SUMMARY_PATH'))
...
pipeline = Pipeline([
    ...
    ("univariate", SelectKBest(score_func=f_classif, k=900)),
...
# Aggregate importance by angle base name (e.g., RH_Angle{(0,1)-(2,3)})
...
with open("features/hand_pose_angles_features.py", "w") as f:
