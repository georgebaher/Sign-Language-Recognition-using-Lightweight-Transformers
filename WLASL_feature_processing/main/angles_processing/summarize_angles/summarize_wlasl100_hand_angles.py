...
import pandas as pd
import json
from WLASL_feature_processing.utils.hand_angles_utils import summarize_single_video_hand_angles
...
wlasl100_hand_angles_path = os.getenv("WLASL100_HAND_ANGLES_PATH")
df = pd.read_parquet(wlasl100_hand_angles_path)
...
for gloss in tqdm(glosses, unit="gloss", total=len(glosses), leave=False, colour="green"):
    for instance in gloss['instances']:
        ...
        summary_df = summarize_single_video_hand_angles(inst_df)
