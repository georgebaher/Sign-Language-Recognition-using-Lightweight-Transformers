...
import pandas as pd
import json
from WLASL_feature_processing.utils.landmarks_utils import summarize_single_video_landmarks
...
wlasl100_hand_landmarks_path = os.getenv("WLASL100_HAND_LANDMARKS_PATH")
...
for gloss in tqdm(glosses, unit="gloss", total=len(glosses), leave=False, colour="green"):
    for instance in gloss['instances']:
        ...
        summary_df = summarize_single_video_landmarks(inst_df)
