...
df = pd.read_parquet(os.getenv('WLASL100_HAND_ANGLES_SUMMARY_PATH'))
...
# Prepare top_features and labels
...
pipeline = Pipeline([
    ...
    ("univariate", SelectKBest(score_func=f_classif, k=400)),
...
# Sort and print top 10 top_features
...
# Aggregate importances by angle base name (e.g., RH_Angle{(0,1)-(2,3)})
...
with open("../top_features/hand_angles_features.py", "w") as f:
