...
df = pd.read_parquet(os.getenv('WLASL100_HAND_LANDMARKS_SUMMARY_PATH'))
...
pipeline = Pipeline([
    ...
    ("univariate", SelectKBest(score_func=f_classif, k=150)),
...
# Sort top_features by total importance
...
with open("../top_features/hand_landmarks_features.py", "w") as f:
