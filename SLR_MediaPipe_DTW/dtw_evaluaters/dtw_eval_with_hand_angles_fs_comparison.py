...
if __name__ == "__main__":
    ...
    # results_df.to_parquet("SLR_MediaPipe_DTW/XXXXX", index=False)
    # plot_dtw_evaluation_results_3(results_df)
    # print("\n📋 Summary of All Runs:")
    # print(results_df.to_string(index=False))

    results_df = pd.read_parquet(r'SLR_MediaPipe_DTW/dtw_eval_hand_angles_all_vs_fs_top_1_match_up_to_30_glosses.parquet')
    plot_dtw_evaluation_results_3(results_df)
