...
if __name__ == "__main__":
    # angle_sets = {
    #     "all_angles": None,
    #     "fs_506": TOP_ANGLE_BASES,
    #     # "fs_top_400": TOP_ANGLE_BASES[:400],
    #     "fs_top_300": TOP_ANGLE_BASES[:300],
    #     "fs_top_200": TOP_ANGLE_BASES[:200],
    #     "fs_top_100": TOP_ANGLE_BASES[:100],
    # }
    #
    ...
    # results_df.to_parquet("SLR_MediaPipe_DTW/XXXX", index=False)
    # plot_dtw_evaluation_results_3(results_df)
    # print("\n📋 Summary of All Runs:")
    # print(results_df.to_string(index=False))

    results_df = pd.read_parquet(r'SLR_MediaPipe_DTW/dtw_eval_hand_pose_angles_all_vs_fs_vs_subsets_of_fs_top_1_match_up_to_30_glosses.parquet')
    plot_dtw_evaluation_results_3(results_df)
